defmodule TypstAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TypstAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TypstAppWeb.Gettext, "errors", msg, opts)
    end
  end
